...
export default function Navbar() {
  ...
  const fetchData = async () => {
    ...
    document.documentElement.style.setProperty('--layout-background', currentSiteAttributes.colors.color_1);
    document.documentElement.style.setProperty('--layout-text-color', currentSiteAttributes.colors.color_2);
    document.documentElement.style.setProperty('--article-h1-color', currentSiteAttributes.colors.color_3);
    document.documentElement.style.setProperty('--article-h2-color', currentSiteAttributes.colors.color_4);
    document.documentElement.style.setProperty('--article-h3-color', currentSiteAttributes.colors.color_5);
      ...
      {({ open }) => (
        <>
          <div className="relative z-10 border-b border-gray-300/60">
            <nav id='layout-navbar' className="mx-auto flex h-20 max-w-7xl items-center bg-white px-4 sm:px-6 lg:border-0 lg:px-8">
