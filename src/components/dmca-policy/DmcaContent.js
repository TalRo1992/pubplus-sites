...
import { getDmcaPolicy } from "../../api/sites";

export default async function DmcaContent() {
  ...
  const modifiedDmcaPolicy = await getModifiedContent(getDmcaPolicy,placeholderMap, 'dmcaPolicy')
